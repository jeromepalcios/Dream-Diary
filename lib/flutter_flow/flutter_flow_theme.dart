...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFDFCD9F);
  late Color secondary = const Color(0xFF7D8934);
  late Color tertiary = const Color(0xFFC09944);
  late Color alternate = const Color(0xFF875F6A);
  late Color primaryText = const Color(0xFF484F6E);
  late Color secondaryText = const Color(0xFF948A8E);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF3C3C4A);
